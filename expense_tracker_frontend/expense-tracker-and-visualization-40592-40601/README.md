...
- In CI, `npm start` exits immediately with code 0 when CI=true to avoid long-lived dev servers. Prefer `npm run start:ci` if your CI checks for a start script specifically.
